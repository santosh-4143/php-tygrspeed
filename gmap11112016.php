...
<html >
  ...
  <body>
  <input id="pac-input1" class="controls" type="text" placeholder="Enter your address"/><input id="pac-input2" class="controls" type="text" placeholder="Enter your phone number"/>
  <input id="pac-input" class="controls" type="text" placeholder="Enter drop location"/>
    <div id="map">
